...
const quick_refresh = 15; // seconds
const slow_refresh = 120; // seconds

let now = new Date();
// var now = new Date(2012, 5, 11, 3, 0, 0);
let three_hours_ago = new Date(now.getTime() - 1000 * 60 * 60 * 3);
let a_day_ago = new Date(now.getTime() - 1000 * 60 * 60 * 24);
...
const renderInputs = function (inputs, optional, sizes) {
