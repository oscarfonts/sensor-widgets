 ...
 */
define('wizard',
    ['../i18n', '../SensorWidget', '../SOS', 'jquery',
        'moment', 'daterangepicker', 'jquery-ui', 'bootstrap', 'highlightjs'],
    function(i18n, SensorWidget, SOS, $, moment) {
    "use strict";
    ...
    function menu() {
        var widgets = ["compass", "gauge", "jqgrid", "map", "panel", "progressbar", "status", "table", "thermometer", "timechart", "windrose"];
